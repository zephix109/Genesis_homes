...
<html>
	<head>
		<title>Tenant Profile Submit</title>
	...
	<body>
		<div id="main">
			...
			<?php	
				...
				//add tuple into rental specs table in database
				...
				$query = "INSERT INTO rental_specs VALUES('$province','$city','$rooms','$price','$date','$id','0','0','0')";
				if(mysqli_query($db,$query))
					echo "<br>Rental preferences updated!";
				else
					echo "Error: ".$query."<br>".mysqli_error($db);
			?>
			</h2>	
